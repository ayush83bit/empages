...
![Search Customer Screen](../images/help/bulk-imps/Screen 1.png)
...
![Customer Details Screen](../images/help/bulk-imps/Screen 2.png)
...
![Verify Customer Screen](../images/help/bulk-imps/Screen 3.png)
...
![File Creation Reference](../images/help/bulk-imps/sample_file_structure.png)
...
![Upload Recipients File](../images/help/bulk-imps/Screen 5.png)
![Upload Recipients File](../images/help/bulk-imps/Screen 6.png)


### Step 6: Monitor batch processing status

- After uploading, navigate to the **Batch History** tab.
- The uploaded batch will appear in the "Bulk Payout History" table.
...
![Batch History Screen](../images/help/bulk-imps/Screen 7.png)
...
![Result File Screen](../images/help/bulk-imps/Screen 8.png)
